...
Originalmente la cantidad máxima de fantasmas que se podían utilizar era de 6 (ya que no habían
más colores para representarlos). Ahora se copia el color Purple para que se puedan agregar más a
los layouts.
